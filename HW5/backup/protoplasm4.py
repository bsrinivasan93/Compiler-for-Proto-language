...
if 'main' not in func_list:
    ...
    exit(1)
#print num_func, func_list

for i in range(num_func):
    func_ircode_list.append(IRCode(func_list[i]))
    #func_ircode_list[i].func_name = func_list[i]
    res.gencode(func_ircode_list[i])
#print num_func, func_ircode_list
...
if num_func == 1:
    ...
    #print "\n\tbigger ircode:"
    #print "opt ircode list", big_ircode.optimized_ircode_list
    #print "spill vertex list", big_ircode.spill_vertex_list
    big_ircode.genASM()
