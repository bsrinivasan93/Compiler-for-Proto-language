...
_lr_productions = [
  ...
  ('pgm -> decl_star','pgm',1,'p_pgm','protoplasm5.py',39),
  ('decl_star -> decl decl_star','decl_star',2,'p_decl_star','protoplasm5.py',44),
  ('decl_star -> empty','decl_star',1,'p_decl_star','protoplasm5.py',45),
  ('decl -> vardecl','decl',1,'p_decl_vardecl','protoplasm5.py',55),
  ('decl -> fundecl','decl',1,'p_decl_fundecl','protoplasm5.py',60),
  ('vardecl -> type varlist SEMICOLON','vardecl',3,'p_vardecl','protoplasm5.py',65),
  ('fundecl -> type IDENTIFIER LPAREN formalsOpt RPAREN stmt','fundecl',6,'p_fundecl','protoplasm5.py',70),
  ('formalsOpt -> formals','formalsOpt',1,'p_formalsOpt','protoplasm5.py',75),
  ('formalsOpt -> empty','formalsOpt',1,'p_formalsOpt','protoplasm5.py',76),
  ('type -> INT','type',1,'p_type_int','protoplasm5.py',86),
  ('type -> BOOL','type',1,'p_type_bool','protoplasm5.py',91),
  ('type -> VOID','type',1,'p_type_void','protoplasm5.py',96),
  ('type -> type LSQUARE RSQUARE','type',3,'p_type_array','protoplasm5.py',101),
  ('varlist -> IDENTIFIER COMMA varlist','varlist',3,'p_varlist_multi','protoplasm5.py',106),
  ('varlist -> IDENTIFIER','varlist',1,'p_varlist_single','protoplasm5.py',111),
  ('formals -> type IDENTIFIER COMMA formals','formals',4,'p_formals','protoplasm5.py',116),
  ('formals -> type IDENTIFIER','formals',2,'p_formals','protoplasm5.py',117),
  ('stmt -> SE SEMICOLON','stmt',2,'p_stmt_SE','protoplasm5.py',127),
  ('stmt -> PRINT LPAREN AE RPAREN SEMICOLON','stmt',5,'p_stmt_print','protoplasm5.py',132),
  ('stmt -> LBRACE vardecl_star stmt_star RBRACE','stmt',4,'p_stmt_block','protoplasm5.py',137),
  ('vardecl_star -> vardecl vardecl_star','vardecl_star',2,'p_vardecl_star','protoplasm5.py',142),
  ('vardecl_star -> empty','vardecl_star',1,'p_vardecl_star','protoplasm5.py',143),
  ('stmt_star -> stmt stmt_star','stmt_star',2,'p_stmt_star','protoplasm5.py',153),
  ('stmt_star -> empty','stmt_star',1,'p_stmt_star','protoplasm5.py',154),
  ('stmt -> IF AE THEN stmt ELSE stmt','stmt',6,'p_stmt_if_else','protoplasm5.py',164),
  ('stmt -> IF AE THEN stmt','stmt',4,'p_stmt_if','protoplasm5.py',169),
  ('stmt -> WHILE AE DO stmt','stmt',4,'p_stmt_while','protoplasm5.py',174),
  ('stmt -> FOR LPAREN SEOpt SEMICOLON AEOpt SEMICOLON SEOpt RPAREN stmt','stmt',9,'p_stmt_for','protoplasm5.py',179),
  ('SEOpt -> SE','SEOpt',1,'p_SEOpt','protoplasm5.py',184),
  ('SEOpt -> empty','SEOpt',1,'p_SEOpt','protoplasm5.py',185),
  ('AEOpt -> AE','AEOpt',1,'p_AEOpt','protoplasm5.py',195),
  ('AEOpt -> empty','AEOpt',1,'p_AEOpt','protoplasm5.py',196),
  ('stmt -> DO stmt WHILE AE SEMICOLON','stmt',5,'p_stmt_do_while','protoplasm5.py',207),
  ('stmt -> RETURN AEOpt SEMICOLON','stmt',3,'p_stmt_return','protoplasm5.py',212),
  ('SE -> lhs EQUALS AE','SE',3,'p_SE_assign','protoplasm5.py',217),
  ('SE -> lhs INCREMENT','SE',2,'p_SE_postinc','protoplasm5.py',222),
  ('SE -> lhs DECREMENT','SE',2,'p_SE_postdec','protoplasm5.py',227),
  ('SE -> INCREMENT lhs','SE',2,'p_SE_preinc','protoplasm5.py',232),
  ('SE -> DECREMENT lhs','SE',2,'p_SE_predec','protoplasm5.py',237),
  ('lhs -> IDENTIFIER','lhs',1,'p_lhs_id','protoplasm5.py',242),
  ('lhs -> arrayAccess','lhs',1,'p_lhs_arrayAccess','protoplasm5.py',247),
  ('AE -> AE binop AE','AE',3,'p_AE_binop','protoplasm5.py',252),
  ('AE -> unop AE','AE',2,'p_AE_unop','protoplasm5.py',257),
  ('AE -> primary','AE',1,'p_AE_primary','protoplasm5.py',262),
  ('AE -> SE','AE',1,'p_AE_SE','protoplasm5.py',267),
  ('AE -> newArray','AE',1,'p_AE_newArray','protoplasm5.py',272),
  ('primary -> INTCONST','primary',1,'p_primary_intconst','protoplasm5.py',277),
  ('primary -> TRUE','primary',1,'p_primary_true','protoplasm5.py',282),
  ('primary -> FALSE','primary',1,'p_primary_false','protoplasm5.py',287),
  ('primary -> INPUT LPAREN RPAREN','primary',3,'p_primary_input','protoplasm5.py',292),
  ('primary -> LPAREN AE RPAREN','primary',3,'p_primary_group','protoplasm5.py',297),
  ('primary -> IDENTIFIER','primary',1,'p_primary_id','protoplasm5.py',302),
  ('primary -> arrayAccess','primary',1,'p_primary_arrayAccess','protoplasm5.py',307),
  ('primary -> functionCall','primary',1,'p_primary_functionCall','protoplasm5.py',312),
  ('arrayAccess -> primary LSQUARE AE RSQUARE','arrayAccess',4,'p_arrayAccess','protoplasm5.py',317),
  ('functionCall -> IDENTIFIER LPAREN argsOpt RPAREN','functionCall',4,'p_functionCall','protoplasm5.py',322),
  ('argsOpt -> args','argsOpt',1,'p_argsOpt','protoplasm5.py',327),
  ('argsOpt -> empty','argsOpt',1,'p_argsOpt','protoplasm5.py',328),
  ('args -> AE COMMA args','args',3,'p_args','protoplasm5.py',338),
  ('args -> AE','args',1,'p_args','protoplasm5.py',339),
  ('newArray -> NEW type dimexpr dim_star','newArray',4,'p_newArray','protoplasm5.py',349),
  ('dim_star -> dim dim_star','dim_star',2,'p_dimstar','protoplasm5.py',354),
  ('dim_star -> empty','dim_star',1,'p_dimstar','protoplasm5.py',355),
  ('dimexpr -> LSQUARE AE RSQUARE','dimexpr',3,'p_dimexpr','protoplasm5.py',365),
  ('dim -> LSQUARE RSQUARE','dim',2,'p_dim','protoplasm5.py',370),
  ('binop -> PLUS','binop',1,'p_binop','protoplasm5.py',376),
  ('binop -> MINUS','binop',1,'p_binop','protoplasm5.py',377),
  ('binop -> STAR','binop',1,'p_binop','protoplasm5.py',378),
  ('binop -> DIV','binop',1,'p_binop','protoplasm5.py',379),
  ('binop -> MOD','binop',1,'p_binop','protoplasm5.py',380),
  ('binop -> AND','binop',1,'p_binop','protoplasm5.py',381),
  ('binop -> OR','binop',1,'p_binop','protoplasm5.py',382),
  ('binop -> EQUAL','binop',1,'p_binop','protoplasm5.py',383),
  ('binop -> NEQUAL','binop',1,'p_binop','protoplasm5.py',384),
  ('binop -> LTHANEQ','binop',1,'p_binop','protoplasm5.py',385),
  ('binop -> LTHAN','binop',1,'p_binop','protoplasm5.py',386),
  ('binop -> GTHANEQ','binop',1,'p_binop','protoplasm5.py',387),
  ('binop -> GTHAN','binop',1,'p_binop','protoplasm5.py',388),
  ('unop -> MINUS','unop',1,'p_unop','protoplasm5.py',394),
  ('unop -> NOT','unop',1,'p_unop','protoplasm5.py',395),
  ('empty -> <empty>','empty',0,'p_empty','protoplasm5.py',409),
]
